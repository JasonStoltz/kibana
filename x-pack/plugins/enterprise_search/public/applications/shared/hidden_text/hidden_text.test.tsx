...
describe('HiddenText', () => {
  it('provides the passed "text" in "hiddenText" field, with all characters replaced with stars by default', () => {
  ...
  it('provides a "toggle" function, which when called, changed "hiddenText" from stars back to the original text', () => {
    let toggleFn = () => {};
